...
Второй раунд — мутационный фаззинг (случайные структурные искажения 8 спек и 4 overrides, 4 сида × ~1400
прогонов, `scratchpad`-скрипт, не в репо): 0 падений, остаток «internal error» сведён к нулю правилами Shape для
