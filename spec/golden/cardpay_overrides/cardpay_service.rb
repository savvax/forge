...
module Provider
  class CardpayService < BaseService
    BASE_URL = ENV.fetch('CARDPAY_BASE_URL', 'https://sandbox.cardpay.example/v2')
    PRODUCTION_URL = 'https://api.cardpay.example/v2'
    ...
    # HMAC-SHA512 over the raw request body, base64-encoded.
