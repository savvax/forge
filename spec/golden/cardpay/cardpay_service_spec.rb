...
RSpec.describe Provider::CardpayService do
  ...
  describe '#create_request' do
    ...
    it 'accepts the flat card form of payout_requisite' do
      ...
      stub = stub_request(:post, create_url).to_return(status: 201, body: create_fixture['response_201'].to_json,
                                                     headers: { 'Content-Type' => 'application/json' })
  ...
  describe '#process_callback' do
    ...
    before do
      operation.provider_operation_key = dig_path(callback['payload'], ["data", "transfer_id"])
    ...
    it 'rejects on transfer.declined' do
      ...
      operation.provider_operation_key = dig_path(failed, ["data", "transfer_id"])
